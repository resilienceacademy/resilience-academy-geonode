...
# ##########################################################
# Run a backup
#  SOURCE_URL=$SOURCE_URL TARGET_URL=$TARGET_URL ./resilienceacademy3/br/backup.sh $BKP_FOLDER_NAME
#   - BKP_FOLDER_NAME:
...
#
# e.g.:
#  docker exec -it django4resilienceacademy3 sh -c 'SOURCE_URL=$SOURCE_URL TARGET_URL=$TARGET_URL ./resilienceacademy3/br/backup.sh $BKP_FOLDER_NAME'
# ##########################################################
...
echo "-----------------------------------------------------"
echo "STARTING resilienceacademy3 BACKUP $(date)"
echo "-----------------------------------------------------"
...
./manage.sh backup -i -f -c $PWD/resilienceacademy3/br/settings_docker.ini --backup-dir /$BKP_FOLDER_NAME/
